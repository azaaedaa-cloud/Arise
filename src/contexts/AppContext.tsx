...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    'hero.title3': 'TO',
    'hero.title4': 'POWER',
    'hero.subtitle': 'Knowledge is the only bridge between where you are and where you belong. Start your ascent today.',
    'hero.cta1': 'Start Your Ascent',
  ...
  ar: {
    ...
    'hero.title3': 'إلى',
    'hero.title4': 'القوة',
    'hero.subtitle': 'المعرفة هي الجسر الوحيد بين مكانك الحالي والمكان الذي تنتمي إليه. ابدأ صعودك اليوم.',
    'hero.cta1': 'ابدأ صعودك',
    'hero.cta2': 'الأساس',
